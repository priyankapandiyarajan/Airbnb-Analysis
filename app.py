...
import sys
sys.path.append('/Users/priyanka/Library/Python/3.9/lib/python/site-packages')


def streamlit_config():

    # page configuration
    page_icon_url = '/Users/priyanka/Desktop/airbnb my proj/airbnb_logo.png'
...
class data_collection:
    try:
        client = MongoClient('mongodb+srv://priyankapandi05:root@airbnbcluster.q5rkw.mongodb.net/sample_airbnb?retryWrites=true&w=majority&appName=AirbnbCluster')

        # Connect to the sample_airbnb database
...
class data_preprocessing:
    ...
    def primary():
        ...
        data = []
        for doc in data_collection.col.find({}, {
            '_id': 1,
            'listing_url': 1,
            'name': 1,
            'property_type': 1,
            ...
            'extra_people': 1,
            'guests_included': 1,
            'images': 1,  # Include the entire images field
            'review_scores': 1  # Include the entire review_scores field
        }):
            data.append(doc)
        ...
        # Process the 'review_scores' field
...
with st.sidebar:
    image_url = '/Users/priyanka/Desktop/airbnb my proj/airbnb_banner.jpg'
